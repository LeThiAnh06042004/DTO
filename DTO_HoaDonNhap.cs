...
namespace DTO
{
    public class DTO_HoaDonNhap
    {
        ...
        public string HDN_NgayNhap { get => _HDN_NgayNhap; set => _HDN_NgayNhap = value; }

        public DTO_HoaDonNhap()
        {

        }
        public DTO_HoaDonNhap(string mahdn, string manv, string mancc, string ngaynhap)
        {
