...
namespace DTO
{
    public class DTO_HoaDonBan
    {
        ...
        public string HDB_NgayBan { get => _HDB_NgayBan; set => _HDB_NgayBan = value; }

        public DTO_HoaDonBan()
        {

        }
        public DTO_HoaDonBan(string mahdb, string manv, string tenkh, string sdtkh, string ngayban)
        {
